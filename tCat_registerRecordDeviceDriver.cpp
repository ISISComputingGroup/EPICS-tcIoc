...
epicsShareExtern dset *pvar_dset_devAaiSoft,
    ...
    *pvar_dset_devSoStdio, *pvar_dset_stringoutval_record_tc_dset,
...
static const char * const deviceSupportNames[] = {
    ...
    "aival_record_tc_dset", "airval_record_tc_dset", "devAoSoft",
    "devAoSoftRaw", "devAoSoftCallback", "aoval_record_tc_dset",
    "aorval_record_tc_dset", "devBiSoft", "devBiSoftRaw",
    "devBiSoftCallback", "devBiDbState", "bival_record_tc_dset",
    "birval_record_tc_dset", "devBoSoft", "devBoSoftRaw",
    "devBoSoftCallback", "devBoGeneralTime", "devBoDbState",
    "boval_record_tc_dset", "borval_record_tc_dset", "devCalcoutSoft",
    ...
    "devMbboDirectSoftCallback", "mbboDirectval_record_tc_dset",
    "mbboDirectrval_record_tc_dset", "devPrintfSoft",
    "devPrintfSoftCallback", "devPrintfStdio", "devSiSoft",
    "devSiSoftCallback", "devTimestampSI", "devSiGeneralTime",
    "devSiEnviron", "stringinval_record_tc_dset", "devSoSoft",
    "devSoSoftCallback", "devSoStdio", "stringoutval_record_tc_dset",
    "devSASoft", "devWfSoft", "waveformval_record_tc_dset"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_airval_record_tc_dset, pvar_dset_devAoSoft,
    ...
    pvar_dset_borval_record_tc_dset, pvar_dset_devCalcoutSoft,
