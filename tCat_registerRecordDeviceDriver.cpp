...
epicsShareExtern dset *pvar_dset_aaival_record_tc_dset;
epicsShareExtern dset *pvar_dset_devAaoSoft;
epicsShareExtern dset *pvar_dset_aaoval_record_tc_dset;
...
epicsShareExtern dset *pvar_dset_aival_record_tc_dset;
epicsShareExtern dset *pvar_dset_airval_record_tc_dset;
...
epicsShareExtern dset *pvar_dset_aoval_record_tc_dset;
epicsShareExtern dset *pvar_dset_aorval_record_tc_dset;
epicsShareExtern dset *pvar_dset_devBiSoft;
epicsShareExtern dset *pvar_dset_devBiSoftRaw;
epicsShareExtern dset *pvar_dset_bival_record_tc_dset;
epicsShareExtern dset *pvar_dset_birval_record_tc_dset;
...
epicsShareExtern dset *pvar_dset_boval_record_tc_dset;
epicsShareExtern dset *pvar_dset_borval_record_tc_dset;
...
epicsShareExtern dset *pvar_dset_longinval_record_tc_dset;
epicsShareExtern dset *pvar_dset_devLoSoft;
epicsShareExtern dset *pvar_dset_devLoSoftCallback;
epicsShareExtern dset *pvar_dset_longoutval_record_tc_dset;
epicsShareExtern dset *pvar_dset_devMbbiSoft;
epicsShareExtern dset *pvar_dset_devMbbiSoftRaw;
epicsShareExtern dset *pvar_dset_mbbival_record_tc_dset;
epicsShareExtern dset *pvar_dset_mbbirval_record_tc_dset;
epicsShareExtern dset *pvar_dset_devMbbiDirectSoft;
epicsShareExtern dset *pvar_dset_devMbbiDirectSoftRaw;
epicsShareExtern dset *pvar_dset_mbbiDirectval_record_tc_dset;
epicsShareExtern dset *pvar_dset_mbbiDirectrval_record_tc_dset;
...
epicsShareExtern dset *pvar_dset_mbboval_record_tc_dset;
epicsShareExtern dset *pvar_dset_mbborval_record_tc_dset;
...
epicsShareExtern dset *pvar_dset_mbboDirectval_record_tc_dset;
epicsShareExtern dset *pvar_dset_mbboDirectrval_record_tc_dset;
...
epicsShareExtern dset *pvar_dset_stringinval_record_tc_dset;
...
epicsShareExtern dset *pvar_dset_stringoutval_record_tc_dset;
epicsShareExtern dset *pvar_dset_devSASoft;
epicsShareExtern dset *pvar_dset_devWfSoft;
epicsShareExtern dset *pvar_dset_waveformval_record_tc_dset;

static const char * const deviceSupportNames[63] = {
    "devAaiSoft",
    "aaival_record_tc_dset",
    "devAaoSoft",
    "aaoval_record_tc_dset",
    "devAiSoft",
    "devAiSoftRaw",
    "devTimestampAI",
    "devAiGeneralTime",
    "aival_record_tc_dset",
    "airval_record_tc_dset",
    "devAoSoft",
    "devAoSoftRaw",
    "devAoSoftCallback",
    "aoval_record_tc_dset",
    "aorval_record_tc_dset",
    "devBiSoft",
    "devBiSoftRaw",
    "bival_record_tc_dset",
    "birval_record_tc_dset",
    "devBoSoft",
    "devBoSoftRaw",
    "devBoSoftCallback",
    "devBoGeneralTime",
    "boval_record_tc_dset",
    "borval_record_tc_dset",
    "devCalcoutSoft",
    "devCalcoutSoftCallback",
    "devEventSoft",
    "devLiSoft",
    "devLiGeneralTime",
    "longinval_record_tc_dset",
    "devLoSoft",
    "devLoSoftCallback",
    "longoutval_record_tc_dset",
    "devMbbiSoft",
    "devMbbiSoftRaw",
    "mbbival_record_tc_dset",
    "mbbirval_record_tc_dset",
    "devMbbiDirectSoft",
    "devMbbiDirectSoftRaw",
    "mbbiDirectval_record_tc_dset",
    "mbbiDirectrval_record_tc_dset",
    "devMbboSoft",
    "devMbboSoftRaw",
    "devMbboSoftCallback",
    "mbboval_record_tc_dset",
    "mbborval_record_tc_dset",
    "devMbboDirectSoft",
    "devMbboDirectSoftRaw",
    "devMbboDirectSoftCallback",
    "mbboDirectval_record_tc_dset",
    "mbboDirectrval_record_tc_dset",
    "devSiSoft",
    "devTimestampSI",
    "devSiGeneralTime",
    "stringinval_record_tc_dset",
    "devSoSoft",
    "devSoSoftCallback",
    "devSoStdio",
    "stringoutval_record_tc_dset",
    "devSASoft",
    "devWfSoft",
    "waveformval_record_tc_dset"
};

static const dset * const devsl[63] = {
    pvar_dset_devAaiSoft,
    pvar_dset_aaival_record_tc_dset,
    pvar_dset_devAaoSoft,
    pvar_dset_aaoval_record_tc_dset,
    pvar_dset_devAiSoft,
    pvar_dset_devAiSoftRaw,
    pvar_dset_devTimestampAI,
    pvar_dset_devAiGeneralTime,
    pvar_dset_aival_record_tc_dset,
    pvar_dset_airval_record_tc_dset,
    pvar_dset_devAoSoft,
    pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback,
    pvar_dset_aoval_record_tc_dset,
    pvar_dset_aorval_record_tc_dset,
    pvar_dset_devBiSoft,
    pvar_dset_devBiSoftRaw,
    pvar_dset_bival_record_tc_dset,
    pvar_dset_birval_record_tc_dset,
    pvar_dset_devBoSoft,
    pvar_dset_devBoSoftRaw,
    pvar_dset_devBoSoftCallback,
    pvar_dset_devBoGeneralTime,
    pvar_dset_boval_record_tc_dset,
    pvar_dset_borval_record_tc_dset,
    ...
    pvar_dset_longoutval_record_tc_dset,
    pvar_dset_devMbbiSoft,
    pvar_dset_devMbbiSoftRaw,
    pvar_dset_mbbival_record_tc_dset,
    ...
    pvar_dset_mbbiDirectrval_record_tc_dset,
    pvar_dset_devMbboSoft,
    pvar_dset_devMbboSoftRaw,
    pvar_dset_devMbboSoftCallback,
    pvar_dset_mbboval_record_tc_dset,
    pvar_dset_mbborval_record_tc_dset,
    ...
    pvar_dset_mbboDirectrval_record_tc_dset,
    pvar_dset_devSiSoft,
    pvar_dset_devTimestampSI,
    pvar_dset_devSiGeneralTime,
    pvar_dset_stringinval_record_tc_dset,
    pvar_dset_devSoSoft,
    ...
    pvar_dset_devSASoft,
    pvar_dset_devWfSoft,
    pvar_dset_waveformval_record_tc_dset
};
...
int tCat_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    registerDevices(pbase, 63, deviceSupportNames, devsl);
    (*pvar_func_asSub)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"tCat_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
