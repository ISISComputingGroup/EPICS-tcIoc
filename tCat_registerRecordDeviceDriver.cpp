...
/* Generated from ../O.Common/tCat.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft,
    *pvar_dset_aaival_record_tc_dset, *pvar_dset_devAaoSoft,
    *pvar_dset_aaoval_record_tc_dset, *pvar_dset_devAiSoft,
    *pvar_dset_devAiSoftRaw, *pvar_dset_devAiSoftCallback,
    *pvar_dset_devTimestampAI, *pvar_dset_devAiGeneralTime,
    *pvar_dset_aival_record_tc_dset, *pvar_dset_airval_record_tc_dset,
    *pvar_dset_aival_record_info_dset, *pvar_dset_devAoSoft,
    *pvar_dset_devAoSoftRaw, *pvar_dset_devAoSoftCallback,
    *pvar_dset_aoval_record_tc_dset, *pvar_dset_aorval_record_tc_dset,
    *pvar_dset_aoval_record_info_dset, *pvar_dset_devBiSoft,
    *pvar_dset_devBiSoftRaw, *pvar_dset_devBiSoftCallback,
    *pvar_dset_devBiDbState, *pvar_dset_bival_record_tc_dset,
    *pvar_dset_birval_record_tc_dset, *pvar_dset_bival_record_info_dset,
    *pvar_dset_devBoSoft, *pvar_dset_devBoSoftRaw,
    *pvar_dset_devBoSoftCallback, *pvar_dset_devBoGeneralTime,
    *pvar_dset_devBoDbState, *pvar_dset_boval_record_tc_dset,
    *pvar_dset_borval_record_tc_dset, *pvar_dset_boval_record_info_dset,
    ...
    *pvar_dset_longinval_record_info_dset, *pvar_dset_devLoSoft,
    *pvar_dset_devLoSoftCallback, *pvar_dset_longoutval_record_tc_dset,
    *pvar_dset_longoutval_record_info_dset, *pvar_dset_devLsiSoft,
    ...
    *pvar_dset_mbbirval_record_tc_dset,
    *pvar_dset_mbbival_record_info_dset, *pvar_dset_devMbbiDirectSoft,
    ...
    *pvar_dset_mbboval_record_tc_dset, *pvar_dset_mbborval_record_tc_dset,
    *pvar_dset_mbboval_record_info_dset, *pvar_dset_devMbboDirectSoft,
    *pvar_dset_devMbboDirectSoftRaw, *pvar_dset_devMbboDirectSoftCallback,
    *pvar_dset_mbboDirectval_record_tc_dset,
    *pvar_dset_mbboDirectrval_record_tc_dset, *pvar_dset_devPrintfSoft,
    ...
    *pvar_dset_devSiEnviron, *pvar_dset_stringinval_record_tc_dset,
    *pvar_dset_stringinval_record_info_dset, *pvar_dset_devSoSoft,
    *pvar_dset_devSoSoftCallback, *pvar_dset_devSoStdio,
    *pvar_dset_stringoutval_record_tc_dset,
    *pvar_dset_stringoutval_record_info_dset, *pvar_dset_devSASoft,
    *pvar_dset_devWfSoft, *pvar_dset_waveformval_record_tc_dset;

static const char * const deviceSupportNames[] = {
    "devAaiSoft", "aaival_record_tc_dset", "devAaoSoft",
    "aaoval_record_tc_dset", "devAiSoft", "devAiSoftRaw",
    "devAiSoftCallback", "devTimestampAI", "devAiGeneralTime",
    "aival_record_tc_dset", "airval_record_tc_dset",
    "aival_record_info_dset", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "aoval_record_tc_dset", "aorval_record_tc_dset",
    "aoval_record_info_dset", "devBiSoft", "devBiSoftRaw",
    "devBiSoftCallback", "devBiDbState", "bival_record_tc_dset",
    "birval_record_tc_dset", "bival_record_info_dset", "devBoSoft",
    "devBoSoftRaw", "devBoSoftCallback", "devBoGeneralTime",
    "devBoDbState", "boval_record_tc_dset", "borval_record_tc_dset",
    "boval_record_info_dset", "devCalcoutSoft", "devCalcoutSoftCallback",
    "devEventSoft", "devHistogramSoft", "devLiSoft", "devLiSoftCallback",
    "devLiGeneralTime", "longinval_record_tc_dset",
    "longinval_record_info_dset", "devLoSoft", "devLoSoftCallback",
    "longoutval_record_tc_dset", "longoutval_record_info_dset",
    "devLsiSoft", "devLsiEnviron", "devLsoSoft", "devLsoSoftCallback",
    "devLsoStdio", "devMbbiSoft", "devMbbiSoftRaw", "devMbbiSoftCallback",
    "mbbival_record_tc_dset", "mbbirval_record_tc_dset",
    "mbbival_record_info_dset", "devMbbiDirectSoft",
    "devMbbiDirectSoftRaw", "devMbbiDirectSoftCallback",
    "mbbiDirectval_record_tc_dset", "mbbiDirectrval_record_tc_dset",
    "devMbboSoft", "devMbboSoftRaw", "devMbboSoftCallback",
    "mbboval_record_tc_dset", "mbborval_record_tc_dset",
    "mbboval_record_info_dset", "devMbboDirectSoft",
    "devMbboDirectSoftRaw", "devMbboDirectSoftCallback",
    "mbboDirectval_record_tc_dset", "mbboDirectrval_record_tc_dset",
    "devPrintfSoft", "devPrintfSoftCallback", "devPrintfStdio",
    "devSiSoft", "devSiSoftCallback", "devTimestampSI",
    "devSiGeneralTime", "devSiEnviron", "stringinval_record_tc_dset",
    "stringinval_record_info_dset", "devSoSoft", "devSoSoftCallback",
    "devSoStdio", "stringoutval_record_tc_dset",
    "stringoutval_record_info_dset", "devSASoft", "devWfSoft",
    "waveformval_record_tc_dset"
};

static const dset * const devsl[] = {
    pvar_dset_devAaiSoft, pvar_dset_aaival_record_tc_dset,
    pvar_dset_devAaoSoft, pvar_dset_aaoval_record_tc_dset,
    pvar_dset_devAiSoft, pvar_dset_devAiSoftRaw,
    pvar_dset_devAiSoftCallback, pvar_dset_devTimestampAI,
    pvar_dset_devAiGeneralTime, pvar_dset_aival_record_tc_dset,
    pvar_dset_airval_record_tc_dset, pvar_dset_aival_record_info_dset,
    pvar_dset_devAoSoft, pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback, pvar_dset_aoval_record_tc_dset,
    pvar_dset_aorval_record_tc_dset, pvar_dset_aoval_record_info_dset,
    pvar_dset_devBiSoft, pvar_dset_devBiSoftRaw,
    pvar_dset_devBiSoftCallback, pvar_dset_devBiDbState,
    pvar_dset_bival_record_tc_dset, pvar_dset_birval_record_tc_dset,
    pvar_dset_bival_record_info_dset, pvar_dset_devBoSoft,
    pvar_dset_devBoSoftRaw, pvar_dset_devBoSoftCallback,
    pvar_dset_devBoGeneralTime, pvar_dset_devBoDbState,
    pvar_dset_boval_record_tc_dset, pvar_dset_borval_record_tc_dset,
    pvar_dset_boval_record_info_dset, pvar_dset_devCalcoutSoft,
    ...
    pvar_dset_longinval_record_tc_dset,
    pvar_dset_longinval_record_info_dset, pvar_dset_devLoSoft,
    pvar_dset_devLoSoftCallback, pvar_dset_longoutval_record_tc_dset,
    pvar_dset_longoutval_record_info_dset, pvar_dset_devLsiSoft,
    pvar_dset_devLsiEnviron, pvar_dset_devLsoSoft,
    ...
    pvar_dset_devMbbiSoft, pvar_dset_devMbbiSoftRaw,
    pvar_dset_devMbbiSoftCallback, pvar_dset_mbbival_record_tc_dset,
    pvar_dset_mbbirval_record_tc_dset, pvar_dset_mbbival_record_info_dset,
...
/* tCat_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"tCat_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    tCat_registerRecordDeviceDriver(*iocshPpdbbase);
}
